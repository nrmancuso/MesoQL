...
class MesoQLParserHelperTest {
    ...
    void inFilter() {
        ...
        final QueryAST.InFilter f = (QueryAST.InFilter) q.where().filters().get(0);
    ...
    void betweenFilter() {
        ...
        final QueryAST.BetweenFilter f = (QueryAST.BetweenFilter) q.where().filters().get(0);
    ...
    void comparisonFilterNumeric() {
        ...
        final QueryAST.ComparisonFilter f = (QueryAST.ComparisonFilter) q.where().filters().get(0);
    ...
    void synthesizeClause() {
        ...
        assertEquals(1, q.outputs().size());
        final QueryAST.SynthesizeClause s = (QueryAST.SynthesizeClause) q.outputs().get(0);
