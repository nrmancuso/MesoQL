...
public class OpenSearchService {
    ...
    private void createIndexFromJson(String index, String json) throws IOException {
        ...
        if (exists) return;
        org.opensearch.client.Request req = new org.opensearch.client.Request("PUT", "/" + index);
    ...
    public SearchResponse<Map> hybridSearch(
        ...
        String vecField = vectorField(index);
        Class<Map> docClass = (Class<Map>) (Class<?>) Map.class;
        ...
        List<Query> filterQueries = filters.stream()
